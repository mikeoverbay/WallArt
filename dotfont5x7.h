...
#else
#include <Arduino.h>   // ESP32 etc.: PROGMEM + pgm_read_byte
#endif 
...
//#define aUML "\x84" // Ã¤ = 0x84
//#define oUML "\x94" // Ã¶ = 0x94
//#define uUML "\x81" // Ã¼ = 0x81
//#define sZET "\xE1" // ÃŸ = 0xE1
//#define AUML "\x8E" // Ã„ = 0x8E
//#define OUML "\x99" // Ã– = 0x99
//#define UUML "\x9A" // Ãœ = 0x9A
...
const unsigned char  font5x7[] PROGMEM = {
  ...
  0x3A, 0x40, 0x40, 0x20, 0x7A, // 0x81 Ã¼
  0x38, 0x54, 0x54, 0x55, 0x59, // 0x82
  0x21, 0x55, 0x55, 0x79, 0x41, // 0x83
  0x21, 0x54, 0x54, 0x78, 0x41, // 0x84 Ã¤
  ...
  0xF0, 0x29, 0x24, 0x29, 0xF0, // 0x8E Ã„
  ...
  0x32, 0x48, 0x48, 0x48, 0x32, // 0x94 Ã¶
  0x32, 0x4A, 0x48, 0x48, 0x30, // 0x95
  0x3A, 0x41, 0x41, 0x21, 0x7A, // 0x96
  0x3A, 0x42, 0x40, 0x20, 0x78, // 0x97
  0x00, 0x9D, 0xA0, 0xA0, 0x7D, // 0x98
  //0x39, 0x44, 0x44, 0x44, 0x39, // 0x99 Ã– (old)
  0x3D, 0x42, 0x42, 0x42, 0x3D, // 0x99 Ã–
  0x3D, 0x40, 0x40, 0x40, 0x3D, // 0x9A Ãœ
  ...
  0x7C, 0x2A, 0x2A, 0x3E, 0x14, // 0xE1 beta / ÃŸ
